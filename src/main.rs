...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let symbols = args.symbols.unwrap_or_default();
    ...
    let url = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?limit=100&sort=volume_24h";
